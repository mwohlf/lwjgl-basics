...
uniform LightSource lights[5];       // see: http://www.lwjgl.org/wiki/index.php?title=GLSL_Tutorial:_Communicating_with_Shaders
...
uniform vec3 lightPosition;          // in world-space will be transformed to cam space
...
void main(void) {
    ...
    // light must already be in world-space, should be the same for all models
