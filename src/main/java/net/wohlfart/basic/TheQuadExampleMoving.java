...
public class TheQuadExampleMoving {
	...
	private void setupTextures() {
		texIds[0] = this.loadPNGTexture("/images/ash_uvgrid01.png", GL13.GL_TEXTURE0);
		texIds[1] = this.loadPNGTexture("/images/ash_uvgrid02.png", GL13.GL_TEXTURE0);
	...
	private int loadShader(String filename, int type) {
		...
		try {
			BufferedReader reader = new BufferedReader(new InputStreamReader(ClassLoader.class.getResourceAsStream(filename)));
	...
	private int loadPNGTexture(String filename, int textureUnit) {
		...
		try {
			...
			net.wohlfart.tools.PNGDecoder decoder = new net.wohlfart.tools.PNGDecoder(in);
