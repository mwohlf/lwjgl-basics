...
public class TrueTypeFont {
	...
	private void drawQuad(
			float drawX, float drawY, float drawX2, float drawY2,
	...
	public void drawString(float x, float y,
		...
		//int bufferSi
		FloatBuffer verticesBuffer = BufferUtils.createFloatBuffer( (endIndex - startIndex) * vectorSite * 4);
		...
		while (i >= startIndex && i <= endIndex) {
			...
			if( intObject != null ) {
				...
				if (charCurrent == '\n') {
					...
					drawQuad(
							(totalwidth + intObject.width) * scaleX + x,
							startY * scaleY + y,
							totalwidth * scaleX + x,
